...
class Category_Metabox_Enhanced {
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-category-metabox-enhanced-public.php';
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Category_Metabox_Enhanced_Public( $this->get_plugin_name(), $this->get_version() );
